...
-- ==========================================
-- CARGA INICIAL DE PERFUMES (CATÁLOGO OFICIAL 2026 - 15 FRAGANCIAS)
-- ==========================================
...
(
  'khamrah-qahwa', '02', 'Khamrah Qahwa', 'Lattafa', 4,
  ...
  '/assets/perfumes/khamrah-qahwa.jpg', '/assets/perfumes/khamrah-qahwa_page.jpg', NULL, 'RIGHT',
...
(
  '9-am-dive', '04', '9 AM Dive', 'Afnan', 6,
  ...
  '{"invierno": 1100, "primavera": 5800, "verano": 6900, "otoño": 2500, "dia": 6700, "noche": 1800}'::jsonb, '{"salida": ["Menta", "Limón", "Pimienta Rosa", "Grosellas Negras"], "corazon": ["Manzana", "Incienso", "Cedro"], "base": ["Jengibre", "Sándalo", "Jazmín", "Pachulí"]}'::jsonb, NULL,
  '/assets/perfumes/9-am-dive.jpg', '/assets/perfumes/9-am-dive_page.jpg', NULL, 'RIGHT',
...
(
  'hawas-ice', '05', 'Hawas Ice', 'Rasasi', 7,
  ...
  '{"invierno": 1300, "primavera": 5300, "verano": 6200, "otoño": 2600, "dia": 5500, "noche": 2300}'::jsonb, '{"salida": ["Manzana", "Limón Italiano", "Bergamota", "Anís Estrellado"], "corazon": ["Ciruela", "Flor Azahar de Naranjo", "Cardamomo"], "base": ["Trozos de Madera", "Musgo", "Almizcle", "Ámbar"]}'::jsonb, NULL,
  '/assets/perfumes/hawas-ice.jpg', '/assets/perfumes/hawas-ice_page.jpg', NULL, 'LEFT',
  'Best Seller Verano', 'Verano / Calor', 'verano', 'dia',
  '["Manzana", "Menta", "Fresco", "Acuático", "Verano"]'::jsonb, '["Aromático Frutal", "Acuático", "Cítrico Gélido", "Almizclado"]'::jsonb, 60, 5.0, true
),
(
  'hawas-kobra', '06', 'Hawas Kobra', 'Rasasi', 8,
...
(
  'fakhar-black', '08', 'Fakhar Black', 'Lattafa', 10,
...
(
  'odyssey-homme', '09', 'Odyssey Homme White Edition', 'Armaf', 11,
  ...
  '{"invierno": 1400, "primavera": 4900, "verano": 5800, "otoño": 2800, "dia": 5100, "noche": 2600}'::jsonb, '{"salida": ["Cardamomo", "Pimienta Rosa", "Menta"], "corazon": ["Salvia", "Notas Acuáticas", "Piña"], "base": ["Cedro", "Amberwood", "Vainilla"]}'::jsonb, NULL,
  '/assets/perfumes/odyssey-homme.jpg', '/assets/perfumes/odyssey-homme_page.jpg', NULL, 'LEFT',
...
(
  'odyssey-mandarin-sky', '10', 'Odyssey Mandarin Sky', 'Armaf', 12,
  ...
  '{"invierno": 2800, "primavera": 5200, "verano": 4100, "otoño": 4600, "dia": 4800, "noche": 4200}'::jsonb, '{"salida": ["Mandarina", "Naranja", "Salvia", "Azafrán"], "corazon": ["Caramelo", "Haba Tonka", "Cempasúchil"], "base": ["Ambroxán", "Vetiver", "Cedro"]}'::jsonb, NULL,
  '/assets/perfumes/odyssey-mandarin-sky.jpg', '/assets/perfumes/odyssey-mandarin-sky_page.jpg', NULL, 'RIGHT',
...
(
  'honor-and-glory', '11', 'Bade''e Al Oud Honor & Glory', 'Lattafa', 13,
  ...
  '{"invierno": 8900, "primavera": 2400, "verano": 950, "otoño": 7100, "dia": 3500, "noche": 7800}'::jsonb, '{"salida": ["Piña Caramelizada", "Crème Brûlée"], "corazon": ["Canela", "Benjuí", "Pimienta Negra", "Azafrán de la India"], "base": ["Vainilla", "Sándalo", "Musgo", "Cachemira"]}'::jsonb, NULL,
  '/assets/perfumes/honor-and-glory.jpg', '/assets/perfumes/honor-and-glory_page.jpg', NULL, 'LEFT',
...
(
  'nitro-red', '12', 'Nitro Red', 'Dumont', 14,
  ...
  '{"invierno": 1800, "primavera": 4600, "verano": 5900, "otoño": 3200, "dia": 4700, "noche": 4100}'::jsonb, '{"salida": ["Manzana", "Lavanda", "Bergamota"], "corazon": ["Sandía", "Cedro", "Cálamo"], "base": ["Ámbar", "Sándalo", "Pachulí"]}'::jsonb, NULL,
  '/assets/perfumes/nitro-red.jpg', '/assets/perfumes/nitro-red_page.jpg', NULL, 'RIGHT',
...
(
  'club-de-nuit-milestone', '13', 'Club De Nuit Milestone', 'Armaf', 15,
  ...
  '{"invierno": 900, "primavera": 4800, "verano": 6500, "otoño": 2300, "dia": 6100, "noche": 1900}'::jsonb, '{"salida": ["Notas Acuáticas", "Frutas Rojas", "Bergamota"], "corazon": ["Sándalo", "Maderas Blancas", "Violeta"], "base": ["Almizcle", "Vetiver", "Ambroxan"]}'::jsonb, NULL,
  '/assets/perfumes/club-de-nuit-milestone.jpg', '/assets/perfumes/club-de-nuit-milestone_page.jpg', NULL, 'LEFT',
...
(
  ...
  '/assets/perfumes/eclaire.jpg', '/assets/perfumes/eclaire_page.jpg', NULL, 'RIGHT',
  'Dulzura Gourmet', 'Otoño / Invierno', 'invierno', 'noche',
  '["Caramelo", "Leche", "Miel", "Vainilla", "Acogedor"]'::jsonb, '["Lactónico Dulce", "Caramelo Dorado", "Vainilla Cremosa", "Miel"]'::jsonb, 55, 5.0, true
),
(
  'yara-pink', '15', 'Yara Pink', 'Lattafa', 17,
  ...
  '{"invierno": 2600, "primavera": 5400, "verano": 4300, "otoño": 2900, "dia": 5700, "noche": 1800}'::jsonb, '{"salida": ["Orquídea", "Heliotropo", "Naranja Tangerina"], "corazon": ["Acorde Goloso", "Frutas Tropicales"], "base": ["Vainilla", "Sándalo", "Almizcle"]}'::jsonb, NULL,
...
ON CONFLICT (id) DO UPDATE SET
  ...
  bottle_side = EXCLUDED.bottle_side,
  badge = EXCLUDED.badge,
  season_badge = EXCLUDED.season_badge,
